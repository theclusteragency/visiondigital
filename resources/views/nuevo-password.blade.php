        ...
        <div class="login-box-body">
            ...
            <form  method="post" class="form-element">
                ...
                <div class="form-group has-feedback">
                    <input id="userEmail" name="userEmail" type="text" class="form-control" placeholder="Nueva contraseña">
                </div>
                <div class="form-group has-feedback">
                    <input id="userPassword" name="userPassword" type="text" class="form-control" placeholder="Confirma tu nueva contraseña">
                </div>
                <div class="row">
                    <div class="col-12 text-center">
                        <button type="button" class="btn btn-info btn-block btn-flat margin-top-10">Aceptar</button>
                    </div>
                </div>
            </form>
