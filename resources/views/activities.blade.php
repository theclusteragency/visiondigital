...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="col-12 col-md-6">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span id="totalActivities" class="info-box-number">-</span>
      ...
      <div id="activityForm" class="row hide">
        <div class="col-md-12">
          <!-- Horizontal Form -->
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Dar de alta actividades</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal form-element">
              <div class="box-body">
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="activityField" placeholder="">
                  </div>
                </div>
              </div>
              <!-- /.box-body -->
              <div class="box-footer">
                <button onclick="createActivity();" type="button" class="btn btn-info pull-right">Agregar</button>
              </div>
              <!-- /.box-footer -->
            </form>
          </div>
        ...
        <div class="col-12">
          <div class="box">
            <div class="box-header">
              ...
              <button type="button" id="addActivityBtn" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Agregar</button>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="activitiesList" class="table table-bordered table-striped table-responsive">
                <thead>
                  <tr>
                    <th>Descripción</th>
                    <th>Acciones</th>
...
@section('page_js')
    ...
    <script>
      $(document).ready(function(){
        ...
        getActivities(printActivitiesList);
      });
    </script>
@endsection